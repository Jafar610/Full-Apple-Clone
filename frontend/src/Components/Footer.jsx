...
function Footer() {
  return (
    <>
    <footer className="flex justify-center items-center mx-40 mt-5 text-gray-700 ">
        <div className="internal-wrapper">
          ...
          <div className="flex justify-between items-center flex-wrap mt-5">
            <div className="links-wrapper-1">
              <h3 className="font-bold text-lg ">Shop and Learn</h3>
              <ul>
                <li><a href="#">Mac</a></li>
                <li><a href="#">iPad</a></li>
            ...
            <div className="links-wrapper-2">
              <h3 className="font-bold text-lg ">Apple Services</h3>
              <ul>
            ...
            <div className="links-wrapper-4">
              ...
              <h3 className="font-bold text-lg ">For Education</h3>
              <ul>
                <li><a href="#">Apple and Education</a></li>
                <li><a href="#">Shop for College</a></li>
              </ul>
              <h3 className="font-bold text-lg ">For Healthcare</h3>
              <ul>
                <li><a href="#">Manage Your Apple ID</a></li>
                <li><a href="#">Apple Store Account</a></li>
                <li><a href="#">iCloud.com</a></li>
              </ul>
              <h3 className="font-bold text-lg ">For Government</h3>
              <ul>
                <li><a href="#">Apple and Education</a></li>
                <li><a href="#">Shop for College</a></li>
              </ul>
            ...
            <div className="links-wrapper-5">
              <h3 className="font-bold text-lg ">Apple Values</h3>
              <ul>
                <li><a href="#">Find a Store</a></li>
                <li><a href="#">Genius Bar</a></li>
                <li><a href="#">Today at Apple</a></li>
              ...
              <h3 className="font-bold text-lg ">About Apple</h3>
              <ul>
                <li><a href="#">Find a Store</a></li>
                <li><a href="#">Genius Bar</a></li>
                <li><a href="#">Today at Apple</a></li>
          ...
          <div className="copyright-wrapper">
            ...
            <hr className="mt-5 text-gray-500 mb-2"/>
            <div className="flex justify-around items-center mb-3">
              <ul className="flex justify-center items-center flex-wrap">
                <li className="mr-5"><a href="#">Privacy Policy</a></li>
                <li className="mr-5"><a href="#">Terms of Use</a></li>
                <li className="mr-5"><a href="#">Sales and Refunds</a></li>
                <li className="mr-5"><a href="#">Legal</a></li>
                <li className="mr-5"><a href="#">Site Map</a></li>
              </ul>
              <div className="flex">
              <div className="mr-5 mt-1"><img src={flag} /></div>
