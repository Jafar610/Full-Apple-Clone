...
function Sidebar() {
  return (
    <>
      <div className="bg-[#181818] w-50 h-screen shadow-sm font-poppins">
        <div className="pl-5">
          <Link to="/dashboard">
          ...
          <h1 className="mt-5 text-lg font-xl text-gray-500">Products</h1>
          <Link>
            <div className="flex justify-start items-center p-3 bg-blue-700 rounded-md hover:bg-[#212121] mb-2">
          ...
          <Link>
            <div className="flex justify-start items-center p-3 bg-blue-700 rounded-md hover:bg-[#212121]">
              <Grip size={25} className=" mr-3 text-white" />
              <h1 className="text-white text-xl font-md ">Products</h1>
            </div>
          </Link>

          <h1 className="mt-5 text-lg font-xl text-gray-500">Orders</h1>
          ...
          <h1 className="mt-5 text-lg font-xl text-gray-500">Settings</h1>
